...
public class HotFix {
    ...
    public void startFix(Context context) throws IllegalAccessException, NoSuchFieldException, ClassNotFoundException {
        ...
        ClassLoader pathClassLoader = context.getClassLoader();//拿到系统默认的PathClassLoader加载器
        DexClassLoader dexClassLoader = new DexClassLoader(dexPath, optPath, null, context.getClassLoader());//加载我们自己的补丁dex
